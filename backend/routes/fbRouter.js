...
passport.use(new Strategy({
  ...
  router.post('/facebook/getCompleteData', async (req, res) => {
    try {
        ...
        //   });
        //   const url2 = `https://graph.facebook.com/oauth/access_token?grant_type=fb_exchange_token&${queryParams2}`;
        ...
        return res.status(200).send({ status: true, fbToken: data.access_token })
    }
    catch (error) {
